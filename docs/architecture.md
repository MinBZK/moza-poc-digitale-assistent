...
> Quickstart, endpoints, .env-configuratie en Docker-instructies staan in de [root README](../README.md). Dit document beschrijft de architectuur, routering en scenario's.
