...
| Veld | Waarde |
|---|---|
| Status | **Vervangen** door het standaard-voorstel in [`moza-mcp-standaard-poc`](https://github.com/MinBZK/moza-mcp-standaard-poc) |
| Datum | 2026-04-01 (oorspronkelijk) — vervangen op 9 mei 2026 |
| Beslisser(s) | Projectteam poc-moza |
| Gerelateerd | PDR-005, [PDR-006](PDR-006-feasibility-conclusie.md) |
...
Op 9 mei 2026 — bij oplevering van het feasibility-onderzoek — is de inhoud overgenomen, gecorrigeerd en uitgebreid in een tekstvoorstel voor de standaard. Dat voorstel is verplaatst naar [`moza-mcp-standaard-poc`](https://github.com/MinBZK/moza-mcp-standaard-poc) (de repo van de standaard zelf), omdat het buiten de scope van deze assistent-PoC valt.
