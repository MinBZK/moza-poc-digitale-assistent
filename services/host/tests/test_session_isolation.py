...
def test_arg_keys_logt_alleen_veldnamen_geen_waarden():
    # Logging bevat alleen de veldnamen; de KvK-waarde mag er nooit in staan.
    out = vlam_host._arg_keys({"kvk_nummer": SESSIE_A, "trefwoord": "energie"})
    assert out == "kvk_nummer, trefwoord"
    assert SESSIE_A not in out
