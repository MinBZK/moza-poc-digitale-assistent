...
- Bij subsidievragen: controleer altijd of de regeling nog open is via de RVO-tool.
- Meld duidelijk of een rapportage of aanvraag daadwerkelijk is ingediend (muterend) of alleen is opgezocht (read-only).
